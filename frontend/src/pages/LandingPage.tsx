...
const reviews = [
  {
    name: "Jack",
    username: "@jack",
    body: "Aspirio transformed my interview preparation. The mock interviews were incredibly realistic!",
  ...
  },
  {
    name: "Jenny",
    username: "@jenny",
    body: "Aspirio's structured approach helped me land my dream job. Thank you!",
  ...
  return (
    <div className="relative font-inter bg-black text-white min-h-screen">
      ...
      <footer className="py-6 bg-gray-900 text-gray-400 text-center">
        <p>© 2025 Aspirio. All rights reserved.</p>
      </footer>
    </div>
  );
}
